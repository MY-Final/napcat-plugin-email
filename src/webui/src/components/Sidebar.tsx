...
import { IconDashboard, IconSettings, IconGroup, IconMail, IconClock, IconGithub, IconPlugin, IconSun } from './icons'
...
const menuItems: { id: PageId; label: string; icon: React.ReactNode }[] = [
    ...
    { id: 'email', label: '邮箱服务', icon: <IconMail size={18} /> },
    { id: 'scheduled', label: '定时邮件', icon: <IconClock size={18} /> },
]
    ...
    return (
        <aside className="w-60 flex-shrink-0 bg-white dark:bg-[#1a1b1d] border-r border-gray-200 dark:border-gray-800 flex flex-col">
            ...
            <div className="px-3 pb-2">
                <a
                    href="https://github.com/MY-Final/napcat-plugin-email/issues"
                    target="_blank"
